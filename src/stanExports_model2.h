...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(90, 88, "end", "model_model2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model2
  : public stan::model::model_base_crtp<model_model2> {
private:
        int N;
        vector_d y;
        int K;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log(y_std, add(multiply(X_std, beta), stan::model::rvalue(f, stan::model::cons_list(stan::model::index_min_max(1, N), stan::model::nil_index_list()), "f")), sigma));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(y_sim, 
                            ...
                            ((normal_rng((multiply(stan::model::rvalue(X_std, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_std"), beta) + get_base1(f, i, "f", 1)), sigma, base_rng__) * sd_y) + mean_y), 
            ...
            for (int j = 1; j <= N_pred; ++j) {
                ...
                stan::model::assign(y_pred, 
                            ...
                            ((normal_rng((multiply(stan::model::rvalue(X_pred_std, stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_pred_std"), beta) + get_base1(f, (N + j), "f", 1)), sigma, base_rng__) * sd_y) + mean_y), 
