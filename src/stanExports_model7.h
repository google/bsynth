...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(125, 123, "end", "model_model7");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= I; ++i) {
                ...
                lp_accum__.add(normal_log(get_base1(y_std, i, "y_std", 1), add(add(multiply(X_std, get_base1(beta, i, "beta", 1)), multiply(get_base1(M_std, i, "M_std", 1), get_base1(gamma, i, "gamma", 1))), stan::model::rvalue(get_base1(f, i, "f", 1), stan::model::cons_list(stan::model::index_min_max(1, N), stan::model::nil_index_list()), "f[i]")), get_base1(sigma, i, "sigma", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
