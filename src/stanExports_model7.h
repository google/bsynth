...
static constexpr std::array<const char*, 127> locations_array__ =
  ...
  " (in 'model7', line 70, column 3 to column 26)",
  " (in 'model7', line 71, column 3 to column 22)",
  " (in 'model7', line 72, column 3 to column 24)",
  " (in 'model7', line 73, column 3 to column 24)",
  " (in 'model7', line 74, column 3 to column 26)",
  " (in 'model7', line 75, column 3 to column 23)",
  " (in 'model7', line 78, column 2 to column 20)",
  " (in 'model7', line 98, column 3 to column 22)",
  " (in 'model7', line 99, column 3 to column 28)",
  " (in 'model7', line 80, column 9 to column 13)",
  " (in 'model7', line 80, column 14 to column 18)",
  " (in 'model7', line 80, column 2 to line 81, column 62)",
  " (in 'model7', line 82, column 9 to column 13)",
  " (in 'model7', line 82, column 14 to column 18)",
  " (in 'model7', line 82, column 2 to column 55)",
  " (in 'model7', line 83, column 2 to column 22)",
  " (in 'model7', line 79, column 15 to line 84, column 3)",
  " (in 'model7', line 79, column 2 to line 84, column 3)",
  " (in 'model7', line 102, column 6 to line 103, column 72)",
  " (in 'model7', line 101, column 21 to line 104, column 6)",
  " (in 'model7', line 101, column 6 to line 104, column 6)",
  " (in 'model7', line 106, column 6 to line 109, column 42)",
  " (in 'model7', line 105, column 25 to line 110, column 6)",
  " (in 'model7', line 105, column 5 to line 110, column 6)",
  " (in 'model7', line 100, column 16 to line 111, column 4)",
  " (in 'model7', line 100, column 3 to line 111, column 4)",
  " (in 'model7', line 88, column 6 to column 29)",
  " (in 'model7', line 89, column 6 to column 29)",
  " (in 'model7', line 90, column 6 to column 27)",
  " (in 'model7', line 91, column 6 to column 29)",
  " (in 'model7', line 92, column 6 to column 27)",
  " (in 'model7', line 93, column 6 to line 94, column 49)",
  " (in 'model7', line 87, column 16 to line 95, column 4)",
  " (in 'model7', line 87, column 3 to line 95, column 4)",
  " (in 'model7', line 21, column 3 to column 18)",
  " (in 'model7', line 22, column 3 to column 18)",
  " (in 'model7', line 23, column 15 to column 16)",
  " (in 'model7', line 23, column 10 to column 11)",
  " (in 'model7', line 23, column 3 to column 18)",
  " (in 'model7', line 24, column 3 to column 18)",
  " (in 'model7', line 25, column 10 to column 11)",
  " (in 'model7', line 25, column 12 to column 13)",
  " (in 'model7', line 25, column 3 to column 17)",
  " (in 'model7', line 26, column 3 to column 20)",
  " (in 'model7', line 27, column 19 to column 20)",
  " (in 'model7', line 27, column 10 to column 11)",
  " (in 'model7', line 27, column 12 to column 15)",
  " (in 'model7', line 27, column 3 to column 22)",
  " (in 'model7', line 28, column 3 to column 23)",
  " (in 'model7', line 29, column 10 to column 16)",
  " (in 'model7', line 29, column 17 to column 18)",
  " (in 'model7', line 29, column 3 to column 27)",
  " (in 'model7', line 30, column 29 to column 30)",
  " (in 'model7', line 30, column 10 to column 16)",
  " (in 'model7', line 30, column 17 to column 20)",
  " (in 'model7', line 30, column 3 to column 32)",
  " (in 'model7', line 33, column 10 to column 11)",
  " (in 'model7', line 33, column 13 to column 14)",
  " (in 'model7', line 33, column 3 to column 22)",
  " (in 'model7', line 34, column 10 to column 16)",
  " (in 'model7', line 34, column 18 to column 19)",
  " (in 'model7', line 34, column 3 to column 32)",
  " (in 'model7', line 35, column 19 to column 20)",
  " (in 'model7', line 35, column 10 to column 11)",
  " (in 'model7', line 35, column 3 to column 22)",
  " (in 'model7', line 36, column 15 to column 16)",
  " (in 'model7', line 36, column 3 to column 18)",
  " (in 'model7', line 37, column 11 to column 12)",
  " (in 'model7', line 37, column 1 to column 14)",
  " (in 'model7', line 38, column 22 to column 23)",
  " (in 'model7', line 38, column 8 to column 9)",
  " (in 'model7', line 38, column 11 to column 14)",
  " (in 'model7', line 38, column 1 to column 25)",
  " (in 'model7', line 39, column 34 to column 35)",
  " (in 'model7', line 39, column 10 to column 16)",
  " (in 'model7', line 39, column 18 to column 21)",
  " (in 'model7', line 39, column 3 to column 37)",
  " (in 'model7', line 40, column 13 to column 23)",
  " (in 'model7', line 40, column 3 to column 26)",
  " (in 'model7', line 41, column 3 to column 34)",
  " (in 'model7', line 43, column 5 to column 17)",
  " (in 'model7', line 42, column 19 to line 44, column 4)",
  " (in 'model7', line 42, column 3 to line 44, column 4)",
  " (in 'model7', line 46, column 12 to column 13)",
  " (in 'model7', line 46, column 5 to column 22)",
  " (in 'model7', line 47, column 12 to column 13)",
  " (in 'model7', line 47, column 5 to column 20)",
  " (in 'model7', line 48, column 24 to column 25)",
  " (in 'model7', line 48, column 12 to column 15)",
  " (in 'model7', line 48, column 5 to column 27)",
  " (in 'model7', line 49, column 22 to column 23)",
  " (in 'model7', line 49, column 12 to column 15)",
  " (in 'model7', line 49, column 5 to column 25)",
  " (in 'model7', line 51, column 8 to column 32)",
  " (in 'model7', line 52, column 8 to column 28)",
  " (in 'model7', line 53, column 8 to column 50)",
  " (in 'model7', line 54, column 8 to column 60)",
  " (in 'model7', line 50, column 19 to line 55, column 8)",
  " (in 'model7', line 50, column 4 to line 55, column 8)",
  " (in 'model7', line 57, column 8 to column 31)",
  " (in 'model7', line 58, column 7 to column 26)",
  " (in 'model7', line 59, column 8 to column 48)",
  " (in 'model7', line 61, column 10 to column 40)",
  " (in 'model7', line 62, column 10 to column 36)",
  " (in 'model7', line 63, column 10 to column 64)",
  " (in 'model7', line 64, column 10 to column 74)",
  " (in 'model7', line 60, column 25 to line 65, column 9)",
  " (in 'model7', line 60, column 8 to line 65, column 9)",
  " (in 'model7', line 56, column 19 to line 66, column 6)",
  " (in 'model7', line 56, column 5 to line 66, column 6)",
  " (in 'model7', line 45, column 3 to line 67, column 4)",
  " (in 'model7', line 70, column 23 to column 24)",
  " (in 'model7', line 71, column 19 to column 20)",
  " (in 'model7', line 71, column 11 to column 12)",
  " (in 'model7', line 72, column 21 to column 22)",
  " (in 'model7', line 72, column 10 to column 13)",
  " (in 'model7', line 73, column 21 to column 22)",
  " (in 'model7', line 74, column 23 to column 24)",
  " (in 'model7', line 75, column 20 to column 21)",
  " (in 'model7', line 75, column 10 to column 14)",
  " (in 'model7', line 78, column 17 to column 18)",
  " (in 'model7', line 78, column 9 to column 13)",
  " (in 'model7', line 98, column 19 to column 20)",
  " (in 'model7', line 98, column 10 to column 11)",
  " (in 'model7', line 99, column 25 to column 26)",
  " (in 'model7', line 99, column 10 to column 16)"};
#include <stan_meta_header.hpp>
class model_model7 final : public model_base_crtp<model_model7> {
private:
  int N;
  int I;
...
public:
  ~model_model7() {}
  model_model7(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_model7_namespace::model_model7";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = I + (I * (K - 1)) + (I * M_K) + I + I + (I * sumN);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_model7_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_model7_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"sigma", "beta", "gamma", "rho",
                "alpha", "eta"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_K) + "}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(sumN) + "}},\"block\":\"parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(sumN) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"y_sim\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "}},\"block\":\"generated_quantities\"},{\"name\":\"y_pred\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_pred) + "}},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((K -1)) + "}},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_K) + "}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(sumN) + "}},\"block\":\"parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(sumN) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"y_sim\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "}},\"block\":\"generated_quantities\"},{\"name\":\"y_pred\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(I) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_pred) + "}},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((I + (I * K)) + (I * M_K)) + I) + I) + (I
      * sumN));
...
using stan_model = model_model7_namespace::model_model7;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model7_namespace::profiles__;
}
#endif
#endif
