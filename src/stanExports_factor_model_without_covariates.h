...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_factor_model_without_covariates");
    ...
    reader.add_event(96, 25, "restart", "model_factor_model_without_covariates");
    reader.add_event(207, 134, "end", "model_factor_model_without_covariates");
    return reader;
}
...
class model_factor_model_without_covariates
  : public stan::model::model_base_crtp<model_factor_model_without_covariates> {
private:
        int L;
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_factor_model_without_covariates_namespace::model_factor_model_without_covariates";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_factor_model_without_covariates_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_factor_model_without_covariates_namespace::model_factor_model_without_covariates stan_model;
#ifndef USING_R
