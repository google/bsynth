...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(69, 67, "end", "model_model1");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log(y_std, multiply(X_std, beta), sigma));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(y_sim, 
                            ...
                            ((normal_rng(multiply(stan::model::rvalue(X_std, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_std"), beta), sigma, base_rng__) * sd_y) + mean_y), 
            ...
            for (int j = 1; j <= N_pred; ++j) {
                ...
                stan::model::assign(y_pred, 
                            ...
                            ((normal_rng(multiply(stan::model::rvalue(X_pred_std, stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_pred_std"), beta), sigma, base_rng__) * sd_y) + mean_y), 
