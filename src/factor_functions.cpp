...
namespace modeld56158f8826a_User_defined_functions_namespace {
...
make_F(const int& T, const Eigen::Matrix<double,-1,1>& diagonal_loadings,
       ...
       pstream__ = 0) {
  return modeld56158f8826a_User_defined_functions_namespace::make_F(T,
...
make_beta(const int& J, const Eigen::Matrix<double,-1,-1>& off,
          ...
          pstream__ = 0) {
  return modeld56158f8826a_User_defined_functions_namespace::make_beta(J,
