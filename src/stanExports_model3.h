...
static constexpr std::array<const char*, 74> locations_array__ =
  ...
  " (in 'model3', line 62, column 3 to column 23)",
  " (in 'model3', line 63, column 3 to column 19)",
  " (in 'model3', line 67, column 3 to column 21)",
  " (in 'model3', line 89, column 3 to column 19)",
  " (in 'model3', line 90, column 3 to column 25)",
  " (in 'model3', line 92, column 6 to column 85)",
  " (in 'model3', line 91, column 18 to line 93, column 4)",
  " (in 'model3', line 91, column 3 to line 93, column 4)",
  " (in 'model3', line 95, column 6 to column 96)",
  " (in 'model3', line 94, column 23 to line 96, column 4)",
  " (in 'model3', line 94, column 3 to line 96, column 4)",
  " (in 'model3', line 82, column 3 to column 23)",
  " (in 'model3', line 84, column 3 to column 23)",
  " (in 'model3', line 85, column 5 to line 86, column 34)",
  " (in 'model3', line 21, column 3 to column 18)",
  " (in 'model3', line 22, column 10 to column 11)",
  " (in 'model3', line 22, column 3 to column 15)",
  " (in 'model3', line 23, column 3 to column 18)",
  " (in 'model3', line 24, column 10 to column 11)",
  " (in 'model3', line 24, column 12 to column 13)",
  " (in 'model3', line 24, column 3 to column 17)",
  " (in 'model3', line 25, column 3 to column 20)",
  " (in 'model3', line 26, column 10 to column 11)",
  " (in 'model3', line 26, column 12 to column 15)",
  " (in 'model3', line 26, column 3 to column 19)",
  " (in 'model3', line 27, column 3 to column 23)",
  " (in 'model3', line 28, column 10 to column 16)",
  " (in 'model3', line 28, column 17 to column 18)",
  " (in 'model3', line 28, column 3 to column 27)",
  " (in 'model3', line 29, column 10 to column 16)",
  " (in 'model3', line 29, column 17 to column 20)",
  " (in 'model3', line 29, column 3 to column 29)",
  " (in 'model3', line 32, column 10 to column 11)",
  " (in 'model3', line 32, column 13 to column 14)",
  " (in 'model3', line 32, column 3 to column 22)",
  " (in 'model3', line 33, column 10 to column 16)",
  " (in 'model3', line 33, column 18 to column 19)",
  " (in 'model3', line 33, column 3 to column 32)",
  " (in 'model3', line 34, column 10 to column 11)",
  " (in 'model3', line 34, column 3 to column 20)",
  " (in 'model3', line 35, column 10 to column 11)",
  " (in 'model3', line 35, column 3 to column 18)",
  " (in 'model3', line 36, column 10 to column 11)",
  " (in 'model3', line 36, column 13 to column 16)",
  " (in 'model3', line 36, column 3 to column 24)",
  " (in 'model3', line 37, column 10 to column 16)",
  " (in 'model3', line 37, column 18 to column 21)",
  " (in 'model3', line 37, column 3 to column 34)",
  " (in 'model3', line 38, column 10 to column 13)",
  " (in 'model3', line 38, column 3 to column 22)",
  " (in 'model3', line 39, column 10 to column 13)",
  " (in 'model3', line 39, column 3 to column 20)",
  " (in 'model3', line 40, column 3 to column 25)",
  " (in 'model3', line 41, column 3 to column 21)",
  " (in 'model3', line 43, column 10 to column 11)",
  " (in 'model3', line 43, column 3 to column 41)",
  " (in 'model3', line 44, column 3 to column 34)",
  " (in 'model3', line 49, column 8 to column 32)",
  " (in 'model3', line 50, column 8 to column 28)",
  " (in 'model3', line 51, column 8 to column 50)",
  " (in 'model3', line 52, column 8 to column 60)",
  " (in 'model3', line 48, column 20 to line 53, column 5)",
  " (in 'model3', line 48, column 5 to line 53, column 5)",
  " (in 'model3', line 55, column 8 to column 32)",
  " (in 'model3', line 56, column 8 to column 28)",
  " (in 'model3', line 57, column 8 to column 50)",
  " (in 'model3', line 58, column 8 to column 60)",
  " (in 'model3', line 54, column 21 to line 59, column 5)",
  " (in 'model3', line 54, column 4 to line 59, column 5)",
  " (in 'model3', line 63, column 11 to column 12)",
  " (in 'model3', line 67, column 10 to column 13)",
  " (in 'model3', line 89, column 10 to column 11)",
  " (in 'model3', line 90, column 10 to column 16)"};
#include <stan_meta_header.hpp>
class model_model3 final : public model_base_crtp<model_model3> {
private:
  int N;
...
public:
  ~model_model3() {}
  model_model3(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_model3_namespace::model_model3";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_model3_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      gamma = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(M_K);
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<false>(y_std,
                         stan::math::add(stan::math::multiply(X_std, beta),
                           stan::math::multiply(M_std, gamma)), sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_model3_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
          ...
          ((stan::math::normal_rng(
              ...
              stan::math::multiply(
                stan::model::rvalue(M_std, "M_std",
                  stan::model::index_uni(i), stan::model::index_omni()),
                gamma)), sigma, base_rng__) * sd_y) + mean_y),
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_K) + "},\"block\":\"parameters\"},{\"name\":\"y_sim\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"y_pred\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_pred) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((K -1)) + "},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M_K) + "},\"block\":\"parameters\"},{\"name\":\"y_sim\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"y_pred\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_pred) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((1 + K) + M_K);
...
using stan_model = model_model3_namespace::model_model3;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model3_namespace::profiles__;
}
#endif
#endif
