...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model4");
    reader.add_event(111, 109, "end", "model_model4");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model4
  : public stan::model::model_base_crtp<model_model4> {
private:
        int N;
        vector_d y;
        int K;
        ...
        int sumN;
public:
    model_model4(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model4_namespace::model_model4";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("eta", "sumN", sumN);
        context__.validate_dims("parameter initialization", "eta", "vector_d", context__.to_vec(sumN));
        Eigen::Matrix<double, Eigen::Dynamic, 1> eta(sumN);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                eta = in__.vector_constrain(sumN, lp__);
            else
                eta = in__.vector_constrain(sumN);
            current_statement_begin__ = 74;
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> f(sumN);
            ...
            stan::math::assign(K_matrix,add(cov_exp_quad(time, alpha, rho), diag_matrix(rep_vector(1e-9, sumN))));
            ...
            stan::math::assign(f, multiply(L_K, eta));
            }
            ...
            lp_accum__.add(normal_log<propto__>(rho, 0, 3));
            ...
            lp_accum__.add(normal_log(y_std, add(add(multiply(X_std, beta), multiply(M_std, gamma)), stan::model::rvalue(f, stan::model::cons_list(stan::model::index_min_max(1, N), stan::model::nil_index_list()), "f")), sigma));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model4_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> eta = in__.vector_constrain(sumN);
        size_t eta_j_1_max__ = sumN;
        for (size_t j_1__ = 0; j_1__ < eta_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 78;
            validate_non_negative_index("f", "sumN", sumN);
            Eigen::Matrix<double, Eigen::Dynamic, 1> f(sumN);
            stan::math::initialize(f, DUMMY_VAR__);
            stan::math::fill(f, DUMMY_VAR__);
...
typedef model_model4_namespace::model_model4 stan_model;
#ifndef USING_R
