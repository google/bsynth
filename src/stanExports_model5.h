...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model5");
    reader.add_event(81, 79, "end", "model_model5");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model5
  : public stan::model::model_base_crtp<model_model5> {
private:
        int N;
        int I;
...
public:
    model_model5(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model5_namespace::model_model5";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= I; ++i) {
                ...
                lp_accum__.add(normal_log(get_base1(y_std, i, "y_std", 1), multiply(X_std, get_base1(beta, i, "beta", 1)), get_base1(sigma, i, "sigma", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model5_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
            ...
            for (int i = 1; i <= I; ++i) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(y_sim, 
                                ...
                                ((normal_rng(multiply(stan::model::rvalue(X_std, stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_std"), get_base1(beta, i, "beta", 1)), get_base1(sigma, i, "sigma", 1), base_rng__) * get_base1(sd_y, i, "sd_y", 1)) + get_base1(mean_y, i, "mean_y", 1)), 
                ...
                for (int j = 1; j <= N_pred; ++j) {
                    ...
                    stan::model::assign(y_pred, 
                                ...
                                ((normal_rng(multiply(stan::model::rvalue(X_pred_std, stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_pred_std"), get_base1(beta, i, "beta", 1)), get_base1(sigma, i, "sigma", 1), base_rng__) * get_base1(sd_y, i, "sd_y", 1)) + get_base1(mean_y, i, "mean_y", 1)), 
...
typedef model_model5_namespace::model_model5 stan_model;
#ifndef USING_R
