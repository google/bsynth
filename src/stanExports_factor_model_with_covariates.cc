...
#include "stanExports_factor_model_with_covariates.h"

RCPP_MODULE(stan_fit4factor_model_with_covariates_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_factor_model_with_covariates")
